...
class _ProdukFormState extends State<ProdukForm>{
            ...
            if(validate){
              ...
              if(validate){
                ...
                String url = Platform.isAndroid
                    ? 'http://192.168.1.130/toko-api/public/produk'
  ...
  Future productUpdate(String kode_produk,String nama_produk, int harga) async {
    final response = await http.put(
      Uri.parse('http://192.168.1.130/toko-api/public/produk/${widget.produk!.id}'),
  ...
  Future productCreate(String url,String kode_produk,String nama_produk,int harga) async {
